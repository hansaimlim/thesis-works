...
flags.DEFINE_integer("num_train_steps", 800000, "Number of training steps.")

flags.DEFINE_integer("num_warmup_steps", 60000, "Number of warmup steps.")
...
flags.DEFINE_integer("keep_checkpoint_max", 40,
...
def model_fn_builder(albert_config, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
   ...
   #      albert_config, model.get_pooled_output(), sentence_order_labels)
    ...
    sentence_order_loss = 0
    sentence_order_example_loss = 0
    sentence_order_log_probs = 0
   # total_loss = masked_lm_loss + sentence_order_loss
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      def metric_fn(*args):
        ...
        #sentence_order_log_probs = sentence_order_log_probs
        #sentence_order_predictions = sentence_order_log_probs
...
def main(_):
  ...
  if FLAGS.do_eval:
    ...
    writer = tf.gfile.GFile(output_eval_file, "a")
