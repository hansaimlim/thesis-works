...
GPU_ID=7
config=/workspace/albert/albert_config/albert_tiny.json
vocab=/workspace/pli_bert/data/vocab/pfam_vocab_triplets.txt
tfrecord=( `ls /workspace/pli_bert/pfam_triplet_corpora/pfam_clustered_triplets_tfrecords_sample/*` )
output_dir=/workspace/pli_bert/pfam_triplet_corpora/albert_pretrained_triplet_sample/
