    ...
    with open(chemfile,'r') as f:
        for line in f:
            ...
            for bond in mol.GetBonds():
                ...
                atoms2bond[(src_atom_idx,tgt_atom_idx)]=bond.GetIdx()
                atoms2bond[(tgt_atom_idx,src_atom_idx)]=bond.GetIdx()
            ...
            for aid in atom_neighbors:
                ...
                neighbor_atom_set = neighbor_atoms+[aid] #neighbors and self
                atoms_by_degree[d].append(neighbor_atom_set) #current atom and neighbors; deg=d
                neighbor_bonds=[]
