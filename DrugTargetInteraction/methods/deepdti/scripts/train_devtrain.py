...
if __name__ == '__main__':
    ...
    edges = load_edges_from_file(os.path.join(opt.data_path, 'devpairs'))
    ...
    dev_evaluator=Evaluator(ikey2smiles,uniprot2pssm,datatype='dev',nsplit=20,nsample=512)
    test_evaluator=Evaluator(ikey2smiles,uniprot2pssm,datatype='test',nsplit=None)
    trainer.train(
        model,
        pred_model,
        edges,
