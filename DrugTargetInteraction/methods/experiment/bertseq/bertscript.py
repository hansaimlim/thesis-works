...
def main():
    ...
    parser.add_argument("--lr", type=float, default=2e-5, help="learning rate of adam")
    parser.add_argument("--warmup", type=int, default=1000, help="warmup steps for Adam optimizer")
    ...
    trainer = BERTTrainer(bert, len(vocab), train_dataloader=train_data_loader, test_dataloader=test_data_loader,
                          ...
                          warmup_steps=args.warmup, with_cuda=args.with_cuda, cuda_devices=args.cuda_devices, log_freq=args.log_freq)
