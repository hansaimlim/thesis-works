...
parser.add_argument('--protein_weight', default=1.0, type=float, help="Scalar weight for protein feature vector (default 1.0)")
...
if __name__ == '__main__':
    ...
    inf = Predictor(opt.model_path, opt.pred_model_path, uniprot2pssm, ikey2smiles, protein_weight=opt.protein_weight)
